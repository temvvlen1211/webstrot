          ...
          <div className="flex h  flex-col items-center w-full  justify-center gap-3  ">
            <div className="flex flex-col justify-center items-center gap-3 w-full ">
              ...
              <p className="max-w-xl">
                ...
                ipsum, nec sagittis sem nibh id elit. Duis sed odio.
              </p>
              <button
                type="button"
            ...
            <div className="md:flex justify-between w-full items-center hidden ">
             ...
             transition-all ease-in duration-200 font-extrabold rounded-full text-sm px-7 py-5 text-center "
                >
                  Love Tarot
                </button>
              </div>
            ...
            <div className="md:flex justify-around w-full  items-center hidden">
              <div className="flex justify-center items-center gap-3 group">
                <button
                  type="button"
                  className="text-white border-8 border-gray-800/100 bg-[var(--maincolor)] group-hover:bg-[var(--bgcolor)]  font-extrabold rounded-full text-sm p-5 text-center  transition-all ease-in duration-200"
