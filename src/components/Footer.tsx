    ...
    <>
      <footer className="bg-black text-white flex justify-center items-center">
        <div className="mx-auto w-full container ">
          <div className="flex justify-between    px-4 py-6 lg:py-8 ">
              ...
              <ul className=" font-medium">
                ...
                <li className="mb-4">
                  <p>
                    ...
                    elit non Vestibulum id ligula porta felis euism od semper.
                  </p>
                </li>
                <li className="mb-4">
                  <a
                    href="#"
                    className="hover:text-purple-500 ease-in-out transition-all"
                  >
                    Readmore
                  </a>
                </li>
                <li className="mb-4">
                  <div className="flex  space-x-5 rtl:space-x-reverse">
                    <a
                      href="#"
                      className="text-gray-400 hover:text-purple-500 dark:hover:text-white"
                    >
                      <svg
                        className="w-4 h-4"
                        aria-hidden="true"
          ...
          <div className="px-4 py-6  md:flex md:items-center md:justify-between">
            <span className="text-sm sm:text-center">
              © Copyright 2020 by Jyotish. All right Reserved - Design By &nbsp;
