export default function Header() {
  return (
    <>
      <nav className="bg-purple-500 flex justify-center items-center text-white ">
        <div
          className="container
         p-3"
        >
          ...
          >
            ...
            <div>
              <div
                className="flex items-center gap-3 text-sm rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                id="user-menu-button"
                aria-expanded="false"
      ...
      <div className="flex justify-center items-center sticky top-0 left-0 ">
